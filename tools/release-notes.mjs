...
const contractNotes = [
  ...
  "Language Serverの初期ワークスペース走査は、ディレクトリ列挙と全project scopeの本文読込を一つのfilesystem jobへ計上します。各scopeの変更はdraftへ隔離し、候補Workspaceの構築後にだけ採用します。",
...
const knownConstraints = [
  ...
  "Language Serverの初期ワークスペース走査は、複数project scopeの合計で本文読込10,000回、取得本文50 MiB、directory entry 100,000件、候補変更10,000回、参加session 10,001件までです。project設定のsession単位の上限も別に適用します。",
