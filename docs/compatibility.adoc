...
For a feature-by-feature view, see xref:syntax-support.adoc[Supported syntax].
For comparison with the AsciiDoc language, see
xref:asciidoc-compatibility.adoc[AsciiDoc specification status].
