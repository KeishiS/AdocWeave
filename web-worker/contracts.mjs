...
export const WASM_API_VERSION = 8;
export const CORE_API_VERSION = 9;
export const CORE_PROFILE_VERSION = 5;
export const HTML_CONTRACT_VERSION = 7;
export const PROJECTION_CONTRACT_VERSION = 9;
export const CONFORMANCE_CONTRACT_VERSION = 9;
